...
public class Main {
    private static final int NUMBER_OF_ACTIONS = 200000; 
    ...
    public static void play() {
        ...
        for(int turn = 0; turn <= NUMBER_OF_ACTIONS; turn++) {
            if(turn == NUMBER_OF_ACTIONS) {
                ...
                print();
            } else if (turn % PRINT_EVERY == 0 || turn == NUMBER_OF_ACTIONS) {
                if(turn != NUMBER_OF_ACTIONS) {
            ...
            players.get(player).calcPlayerLevel();
        }  
    }
    ...
    public static void sorts() {
        ...
        print();
        System.out.println("Sorted By Total Points:");
        Collections.sort(players, Player.Comparators.TOTALXP);
        print();
